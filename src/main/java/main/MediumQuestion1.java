	...
	public static void main(String[] args) {
		...
		switch (select) {
			case 1:
				...
				System.out.print("You have to pay Rs "+cust.getBillAmount(purchasedAmt));
				break;
			case 2:
				takeInput();
				...
				System.out.print("You have to pay Rs "+cust1.getBillAmount(purchasedAmt));
				break;
